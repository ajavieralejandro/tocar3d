...
const Contact = () =>{
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_o0h1k9j', 'template_cgp071l', form.current, 'b-O1A-6pdKQ3xod4a')
        .then((result) => {
            alert(result.text);
        }, (error) => {
            alert(error.text);
        ...
        <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            <form  ref={form} onSubmit={sendEmail} class="space-y-8">
                <div>
                    ...
                    <input type="email" name="user_email" id="email" class="shadow-sm bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="email@gmail.com" required />
                </div>
                <div>
                    <label for="subject" class="block mb-2 text-sm font-medium text-white900 dark:text-white300">Nombre</label>
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea id="message" name='message' rows="6" class="block p-2.5 w-full text-sm text-black bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Dejanos un comentario"></textarea>
                </div>
